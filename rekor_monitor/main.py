...
def inclusion(log_index, artifact_filepath, debug=False):
    ...
    verify_inclusion(
        DefaultHasher, (proof["logIndex"], proof["treeSize"]), (leaf_hash, proof["rootHash"]), proof["hashes"]
    )
...
def consistency(prev_checkpoint, debug=False):
    ...
    verify_consistency(
        DefaultHasher,
        (prev_checkpoint.get("treeSize"), latest_checkpoint.get("treeSize")),
        proof.get("hashes"),
        (prev_checkpoint.get("rootHash"), latest_checkpoint.get("rootHash")),
    )
